...
class DensePassageRetriever(BaseRetriever):
        ...
        **Example:**
        ...
        if single_model_path is None:
            self.query_tokenizer = Tokenizer.load(pretrained_model_name_or_path=query_embedding_model,
                                                  ...
                                                  do_lower_case=query_lower_case,
            ...
            self.passage_tokenizer = Tokenizer.load(pretrained_model_name_or_path=passage_embedding_model,
                                                    revision=model_version,
                                                    do_lower_case=passage_lower_case,
                                                    use_fast=use_fast_tokenizers,
            ...
            self.model = BiAdaptiveModel.load(single_model_path, lm1_name='query', lm2_name='passage', device=self.device)
    ...
    def train(self,
              ...
              as_farm: bool = False,
              query_encoder_save_dir: str = "query",
              passage_encoder_save_dir: str = "passage"
              ):
        """
    ...
    def save(self, save_dir: Union[Path, str], query_encoder_dir: str = "query",
             passage_encoder_dir: str = "passage", as_farm: bool = False):
        """
    ...
    def load(cls,
             ...
             use_fast_tokenizers: bool = True,
             similarity_function: str = "dot_product",
             query_encoder_dir: str = "query",
             query_lower_case: bool = True,
             passage_encoder_dir: str = "passage",
             passage_lower_case: bool = True,
             as_farm: bool = False
             ):
        """
        ...
        if as_farm:
            dpr = cls(
                ...
                single_model_path=load_dir,
                query_lower_case=query_lower_case,
                passage_lower_case=passage_lower_case,
                max_seq_len_query=max_seq_len_query,
                max_seq_len_passage=max_seq_len_passage,
                use_gpu=use_gpu,
